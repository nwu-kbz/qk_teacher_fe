<template>
  <div class="main">
    ...
    <div class="main-page">
      ...
      <Input class='input_message' v-model="username" prefix="ios-contact-outline" placeholder="用户名" style="width: auto"
             clearable/>
      <Input class='input_message' v-model="password" prefix="ios-lock-outline" placeholder="密码" style="width: auto"
             clearable
             type="password"/>
